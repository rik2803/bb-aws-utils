...
#     * Created file is ${PARENT_SLUG}-${BITBUCKET_COMMIT}.zip as generated by aws_s3_generate_filename
#
# Globals:
...
#
# Expects:
#     * Uploaded object name is ${PARENT_SLUG}-${BITBUCKET_COMMIT}.zip as generated by aws_s3_generate_filename
#
# Globals:
#     * PARENT_SLUG: Set by bootstrapping bb-aws-utils
#     * BITBUCKET_REPO_SLUG: provided by BitBucket pipelines
...
aws_s3_deploy_artifact() {
  ...
  aws_s3_download_artifact "$(aws_s3_generate_filename)" "$(aws_s3_generate_zip_filename)"
